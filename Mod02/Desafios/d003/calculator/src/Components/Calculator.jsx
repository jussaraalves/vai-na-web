...
import {Button, Container, Title, CustomButton, CustomButton2, Row, View} from './styled';
  ...
  return(
    <Container>
      ...
      <Row>
        ...
        <CustomButton2 onClick={operatorHandler} value="/">/</CustomButton2>
      </Row>
      <Row>
        <Button onClick={inputNum} value={7}>7</Button>
        <Button onClick={inputNum} value={8}>8</Button>
        <Button onClick={inputNum} value={9}>9</Button>
        <CustomButton2 onClick={operatorHandler} value="X">X</CustomButton2>
      </Row>
      <Row>
